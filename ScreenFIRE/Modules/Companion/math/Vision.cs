...
namespace ScreenFIRE.Modules.Companion.math {
	...
	internal class Vision {
		...
		///		<list type="bullet">
		///			<item>
		///				(0&lt;=&lt;1) How much of <paramref name="foreColor"/> to keep, “on top of” <paramref name="backColor"/>.
		///			</item>
		///			<item>
		///				-1 to use Alpha of <paramref name="foreColor"/>
		///			</item>
		///		</list>
		/// </param>
		/// <returns>The blended color.</returns>
		public static gdk.RGBA BlendColors(gdk.RGBA foreColor, gdk.RGBA backColor, double amount = -1) {
			...
			result.Red = (byte)((foreColor.Red * amount) + backColor.Red * (1 - amount));
